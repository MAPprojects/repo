...
public class AddGrdController extends AbstractController implements Observer<Grade> {
    ...
    public AddGrdController(StudentService studentService, GradeService gradeService, AssignmentService assignmentService, GeneralService generalService) {
        this.studentService = studentService;
        this.gradeService = gradeService;
        this.assignmentService = assignmentService;
        this.generalService = generalService;
    ...
    public void handleBackGrdStd() throws IOException {
    ...
    public void handleAdd() throws  Exception{
        try {
            gradeService.addGrade(comboBoxStd.getSelectionModel().getSelectedItem().getIdStudent(),
