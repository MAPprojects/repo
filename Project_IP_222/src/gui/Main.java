...
public class Main extends Application {
    ...
    private GenericRepository<Integer, Student> studRepo=new StudentXMLRepository("src\\lab\\repository\\XML\\student.xml",sVal);
    ...
    private GenericRepository<Integer, Homework> hmwkRepo = new HomeworkXMLRepository("src\\lab\\repository\\XML\\homeworks.xml",hVal);
    ...
    private GenericRepository<Pair<Student,Homework>, Grade2> grRepo2 = new GradeXMLRepository("src\\lab\\repository\\XML\\grades.xml",gVal, studRepo, hmwkRepo);

    private PasswordValidator pVal= new PasswordValidator();
    private GenericRepository<String, Password> psswRepo=new PasswordFileRepository("src\\lab\\repository\\FILE\\passwords.txt",pVal);
