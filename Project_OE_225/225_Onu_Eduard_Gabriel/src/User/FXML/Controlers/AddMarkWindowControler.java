...
public class AddMarkWindowControler implements Initializable, Observer {
    ...
    public void setMarksViewControler(MarksViewControler marksViewControler){
        this.marksViewControler = marksViewControler;
    }
