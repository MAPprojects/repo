...
public class MarksViewControler implements Initializable, Observer {
    ...
    public void setAddMarkWindowControler(AddMarkWindowControler addMarkWindowControler) {
        this.addMarkWindowControler = addMarkWindowControler;
    }
    ...
    private void selectItems(){
        ...
        if(notaTranslated == null){
            addMarkWindowControler.selectStudentAndHomework(null,null);
            return;
        }
        ...
        addMarkWindowControler.selectStudentAndHomework(student,tema);
        addMarkWindowControler.setMarkText(notaTranslated.getMark());
    }

    private void configureForAdd(){
        addMarkWindowControler.setTitleLable("Add a mark to a student");
        addMarkWindowControler.enableAll();
        addMarkWindowControler.setFunction(notaService::addNota);
    ...
    private void configureForUpdate(){
        selectItems();
        addMarkWindowControler.setTitleLable("Edit the student's mark");
        addMarkWindowControler.disableAll();
        addMarkWindowControler.setFunction(notaService::updateNota);
        labelMarkWindow.setVisible(false);
        marksTextArea.setVisible(false);
    }
