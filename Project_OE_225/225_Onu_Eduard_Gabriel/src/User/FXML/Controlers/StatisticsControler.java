...
public class StatisticsControler implements Initializable, Observer {
    ...
    private PDFSaveControler saveControler;
    ...
    public void setPdfControler(PDFSaveControler saveControler){
