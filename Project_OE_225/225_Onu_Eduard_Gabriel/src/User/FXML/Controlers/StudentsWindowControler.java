...
public class StudentsWindowControler implements Observer,Initializable {
    ...
    private StudentEditWindowViewControler studentEditWindowViewControler;
    ...
    public void handleEditEvent(ActionEvent event,Button btn) {
        ...
        studentEditWindowViewControler.setFieldsText(student.getNume(), student.getEmail(), student.getCadruDidactic(), student.getGrupa() + "");
    }
    ...
    public void handleListStudent(ActionEvent event){
        ...
        studentEditWindowViewControler.clearFields();
    ...
    public StudentsWindowControler(){}
    ...
    public void addEditWindowControler(StudentEditWindowViewControler studentEditWindowViewControler){
        this.studentEditWindowViewControler = studentEditWindowViewControler;
    }
