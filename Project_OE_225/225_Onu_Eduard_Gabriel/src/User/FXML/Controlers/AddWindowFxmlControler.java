...
public class AddWindowFxmlControler implements Initializable {
    ...
    public void setStudentWindowControler(StudentsWindowControler studentWindowControler){
