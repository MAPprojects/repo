...
public class StudentEditWindowViewControler implements Initializable {
    ...
    public StudentEditWindowViewControler(){ }

    public void setStudentsWindowControler(StudentsWindowControler studentsWindowControler){
    ...
    public void handleSaveButton(ActionEvent event){
        ...
        try {
            studentsWindowControler.handleEditStudent(textFieldName.getText(), textFieldEmail.getText(), textFieldTeacher.getText(), textFieldGroup.getText() .equals("") ? -1 + "" : textFieldGroup.getText());
            clearFields();studentsWindowControler.backToMainWindow();
    ...
    public void handleBackButton(ActionEvent event){
        studentsWindowControler.backToMainWindow();clearFields();
    }
