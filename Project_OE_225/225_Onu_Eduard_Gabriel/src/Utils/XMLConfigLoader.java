...
public class XMLConfigLoader {
    ...
    private XMLConfigLoader(){
        ...
        try{
            document = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File("C:\\Users\\Onu Edy\\Desktop\\Project\\225_Onu_Eduard_Gabriel\\src\\Config\\config.xml"));
    ...
    public  Repository <Student> getStudentsRepo()throws  Exception{
        ...
        fileMover.setCurrentLocation("C:\\Users\\Onu Edy\\Desktop\\Project\\225_Onu_Eduard_Gabriel\\src\\Config".concat("\\"+getType()));
        fileMover.setDestination("C:\\Users\\Onu Edy\\Desktop\\Project\\225_Onu_Eduard_Gabriel");
        fileMover.moveAll();
